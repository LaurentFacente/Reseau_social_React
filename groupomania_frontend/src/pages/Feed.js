...
const Posts = () => {
	...
	const deleteProfil = async () => {
		...
		try {
			...
			window.confirm(
				`La supression de votre profil est irreversible, êtes-vous sur ?`
			);
	...
	return (
		<div>
			...
			<div className='container'>
				...
				>
					<p className='creez'>
						Creez et partager un article avec vos collaborateurs
					</p>
					<textarea
						name='title'
						id='message'
					...
					<div className='parent-div'>
						<button className='btn-upload'>Ajoutez une photo</button>
						<input
							name='attachment'
							type='file'
							id='attachment'
					...
					<button name='submit' type='submit' onClick={handlePost}>
						Envoyer
					</button>
				</form>
			</div>
